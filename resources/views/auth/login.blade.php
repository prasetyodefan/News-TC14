    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div class="p-6">
            <div class="flex justify-center mb-4">
                <img src="https://talenthub.kemnaker.go.id/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FLogo.c19b844f.png&w=128&q=75" alt="News Talenthub Logo" class="h-12">
            </div>
            ...
            <div class="mt-4 flex justify-between items-center">
                ...
                <h3>Belum punya akun ? <a href="{{ route('register') }}" class="text-blue-600 hover:underline dark:text-blue-500">
                        Daftar Sekarang
                    </a></h3>
