...
@section('content')
    ...
    <div id="default-tab-content">
        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="editor-choice" role="tabpanel" aria-labelledby="editor-choice-tab">
            <div class="mb-4">
                <!-- Gambar utama dari editor's choice dihilangkan -->
                {{-- <img src="{{ $editorChoiceMain['image_url'] }}" alt="{{ $editorChoiceMain['title'] }}" class="w-full h-auto rounded-lg mb-4"> --}}
        ...
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="komunitas" role="tabpanel" aria-labelledby="komunitas-tab">
            <div class="mb-4">
                <!-- Gambar utama dari komunitas dihilangkan -->
                {{-- <img src="{{ $komunitasMain['image_url'] }}" alt="{{ $komunitasMain['title'] }}" class="w-full h-auto rounded-lg mb-4"> --}}
        ...
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="opini" role="tabpanel" aria-labelledby="opini-tab">
            <div class="mb-4">
                ...
                {{-- <img src="{{ $opiniMain['image_url'] }}" alt="{{ $opiniMain['title'] }}" class="w-full h-auto rounded-lg mb-4"> --}}
